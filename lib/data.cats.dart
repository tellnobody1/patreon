final Map<String, Set<String>> cats = {
  ...
  'Готування': {'besahy'},
  'Гроші': {'costua', 'diypodcast', 'familybudgetcomua', 'vovkst'},
  ...
  'Книги': {'23daphnia', 'annika_blog', 'asambleyA', 'beautyandgloom', 'chtyvo', 'chytomo', 'diasporiana', 'enma_and_books', 'GulbanuBibicheva', 'kliusmarichka', 'knyzhkova_dylerka', 'kultpodcast', 'kuznetsovalife', 'liubovgoknyg', 'mangua', 'mariamblog', 'paralel3', 'robmenus', 'svitlana', 'symonenko', 'TheAsya', 'vertigoUA', 'vrajennya', 'vyshnevyjcvit'},
  ...
  'Різне': {'balytska', 'behindthenews', 'ChasIstoriy', 'deadlinetalkshow', 'inshe', 'itworksonmypc', 'iyura', 'krutoznavstvo', 'liganet', 'lustrum', 'manifestplatform', 'obrazpublicua', 'ppidcast', 'radiopodil', 'radioskorbota', 'shitiknowlive', 'soblya', 'tatysho', 'techtoloka', 'totem_publisher', 'zasnovnyky'},
